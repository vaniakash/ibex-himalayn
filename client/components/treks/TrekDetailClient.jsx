        ...
        <aside className="detail-right" id="booking">
          <div className="booking-card-new">
            ...
            <div className="booking-card-footer">
              <a href="https://wa.me/918126000000" target="_blank" rel="noopener noreferrer" className="booking-contact-link">
              ...
              <a href="tel:+918126000000" className="booking-contact-link">
                <FiPhone size={15} style={{ color: '#c8602a' }} />
                Call us — 080 468 01269
              </a>
            </div>
          </div>
